...
final class AdjustedTimeMark extends TimeMark {
    ...
    public double elapsedNow() {
        return Duration.m989minusLRDsOJo(this.mark.elapsedNow(), this.adjustment);
    }

    @Override // kotlin.time.TimeMark
    /* renamed from: plus-LRDsOJo */
    public TimeMark mo963plusLRDsOJo(double duration) {
        return new AdjustedTimeMark(this.mark, Duration.m990plusLRDsOJo(this.adjustment, duration), null);
    }
}
