...
public final class TestTimeSource extends AbstractLongTimeSource {
    ...
    public final void m1013plusAssignLRDsOJo(double duration) {
        long j;
        double dM998toDoubleimpl = Duration.m998toDoubleimpl(duration, getUnit());
        long j2 = (long) dM998toDoubleimpl;
        if (j2 != Long.MIN_VALUE && j2 != LongCompanionObject.MAX_VALUE) {
            ...
            double d = this.reading + dM998toDoubleimpl;
    ...
    private final void m1012overflowLRDsOJo(double duration) {
        throw new IllegalStateException("TestTimeSource will overflow if its reading " + this.reading + "ns is advanced by " + Duration.m1004toStringimpl(duration) + '.');
    }
}
