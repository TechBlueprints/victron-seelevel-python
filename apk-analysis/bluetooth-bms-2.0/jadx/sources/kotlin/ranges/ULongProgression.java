...
public class ULongProgression implements Iterable<ULong>, KMappedMarker {
    ...
    private ULongProgression(long j, long j2, long j3) {
        ...
        this.first = j;
        this.last = UProgressionUtilKt.m906getProgressionLastElement7ftBX0g(j, j2, j3);
        this.step = j3;
    }
    ...
    public int hashCode() {
        ...
        long j = this.first;
        int iM167constructorimpl = ((int) ULong.m167constructorimpl(j ^ ULong.m167constructorimpl(j >>> 32))) * 31;
        long j2 = this.last;
        int iM167constructorimpl2 = (iM167constructorimpl + ((int) ULong.m167constructorimpl(j2 ^ ULong.m167constructorimpl(j2 >>> 32)))) * 31;
        long j3 = this.step;
        return ((int) (j3 ^ (j3 >>> 32))) + iM167constructorimpl2;
    }
    ...
    public String toString() {
        ...
        if (this.step > 0) {
            ...
            sb.append(ULong.m204toStringimpl(this.first));
            sb.append("..");
            sb.append(ULong.m204toStringimpl(this.last));
            sb.append(" step ");
            j = this.step;
        } else {
            sb = new StringBuilder();
    ...
    public static final class Companion {
        ...
        public final ULongProgression m923fromClosedRange7ftBX0g(long rangeStart, long rangeEnd, long step) {
