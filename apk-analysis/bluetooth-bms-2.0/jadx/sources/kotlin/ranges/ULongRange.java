...
public final class ULongRange extends ULongProgression implements ClosedRange<ULong> {
    ...
    public /* bridge */ /* synthetic */ boolean contains(Comparable comparable) {
        return m924containsVKZWuLQ(((ULong) comparable).getData());
    }

    @Override // kotlin.ranges.ClosedRange
    public ULong getStart() {
        return ULong.m161boximpl(getFirst());
    }

    @Override // kotlin.ranges.ClosedRange
    public ULong getEndInclusive() {
        return ULong.m161boximpl(getLast());
    }

    /* renamed from: contains-VKZWuLQ, reason: not valid java name */
    public boolean m924containsVKZWuLQ(long value) {
    ...
    public int hashCode() {
        ...
        return ((int) ULong.m167constructorimpl(getLast() ^ ULong.m167constructorimpl(getLast() >>> 32))) + (((int) ULong.m167constructorimpl(getFirst() ^ ULong.m167constructorimpl(getFirst() >>> 32))) * 31);
    }

    @Override // kotlin.ranges.ULongProgression
    public String toString() {
        return ULong.m204toStringimpl(getFirst()) + ".." + ULong.m204toStringimpl(getLast());
    }
