...
public final class UIntRange extends UIntProgression implements ClosedRange<UInt> {
    ...
    public /* bridge */ /* synthetic */ boolean contains(Comparable comparable) {
        return m922containsWZ4Q5Ns(((UInt) comparable).getData());
    }

    @Override // kotlin.ranges.ClosedRange
    public UInt getStart() {
        return UInt.m92boximpl(getFirst());
    }

    @Override // kotlin.ranges.ClosedRange
    public UInt getEndInclusive() {
        return UInt.m92boximpl(getLast());
    }

    /* renamed from: contains-WZ4Q5Ns, reason: not valid java name */
    public boolean m922containsWZ4Q5Ns(int value) {
    ...
    public String toString() {
        return UInt.m135toStringimpl(getFirst()) + ".." + UInt.m135toStringimpl(getLast());
    }
