...
public final class UIntArray implements Collection<UInt>, KMappedMarker {
    ...
    public static final /* synthetic */ UIntArray m142boximpl(int[] v) {
    ...
    public boolean equals(Object other) {
        return m147equalsimpl(this.storage, other);
    }
    ...
    public final /* bridge */ boolean contains(Object obj) {
        if (obj instanceof UInt) {
            return m157containsWZ4Q5Ns(((UInt) obj).getData());
        }
        return false;
    }
    ...
    public static int[] m143constructorimpl(int i) {
        return m144constructorimpl(new int[i]);
    }

    /* renamed from: get-impl, reason: not valid java name */
    public static final int m149getimpl(int[] iArr, int i) {
        return UInt.m98constructorimpl(iArr[i]);
    }

    /* renamed from: set-VXSXFK8, reason: not valid java name */
    public static final void m154setVXSXFK8(int[] iArr, int i, int i2) {
        iArr[i] = i2;
    }

    /* renamed from: getSize-impl, reason: not valid java name */
    public static int m150getSizeimpl(int[] iArr) {
        return iArr.length;
    }

    /* renamed from: iterator-impl, reason: not valid java name */
    public static UIntIterator m153iteratorimpl(int[] iArr) {
    ...
    /* renamed from: contains-WZ4Q5Ns, reason: not valid java name */
    public static boolean m145containsWZ4Q5Ns(int[] iArr, int i) {
        return ArraysKt.contains(iArr, i);
    }

    /* renamed from: containsAll-impl, reason: not valid java name */
    public static boolean m146containsAllimpl(int[] iArr, Collection<UInt> elements) {
    ...
    public static boolean m152isEmptyimpl(int[] iArr) {
