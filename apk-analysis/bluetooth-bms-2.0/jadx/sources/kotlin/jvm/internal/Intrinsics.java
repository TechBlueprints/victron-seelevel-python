...
public class Intrinsics {
    ...
    private static void throwParameterIsNullException(String str) {
        ...
        throw ((IllegalArgumentException) sanitizeStackTrace(new IllegalArgumentException("Parameter specified as non-null is null: method " + stackTraceElement.getClassName() + Consts.DOT + stackTraceElement.getMethodName() + ", parameter " + str)));
    }
