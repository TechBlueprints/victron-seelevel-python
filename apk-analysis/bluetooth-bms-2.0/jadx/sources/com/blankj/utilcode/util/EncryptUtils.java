...
public final class EncryptUtils {
    ...
    */
    ...
    private static byte[] rsaTemplate(byte[] bArr, byte[] bArr2, int i, String str, boolean z) throws InvalidKeySpecException, NoSuchPaddingException, NoSuchAlgorithmException, InvalidKeyException {
