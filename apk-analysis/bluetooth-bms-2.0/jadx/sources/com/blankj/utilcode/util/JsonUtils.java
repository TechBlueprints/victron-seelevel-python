...
public final class JsonUtils {
    ...
    public static int getInt(JSONObject jSONObject, String str, int i) {
        return ((Integer) getValueByType(jSONObject, str, Integer.valueOf(i), TYPE_INT)).intValue();
    }
    ...
    public static int getInt(String str, String str2, int i) {
        return ((Integer) getValueByType(str, str2, Integer.valueOf(i), TYPE_INT)).intValue();
    }
    ...
    public static long getLong(JSONObject jSONObject, String str, long j) {
        return ((Long) getValueByType(jSONObject, str, Long.valueOf(j), TYPE_LONG)).longValue();
    }
    ...
    public static long getLong(String str, String str2, long j) {
        return ((Long) getValueByType(str, str2, Long.valueOf(j), TYPE_LONG)).longValue();
    }
    ...
    public static double getDouble(JSONObject jSONObject, String str, double d) {
        return ((Double) getValueByType(jSONObject, str, Double.valueOf(d), TYPE_DOUBLE)).doubleValue();
    }
    ...
    public static double getDouble(String str, String str2, double d) {
        return ((Double) getValueByType(str, str2, Double.valueOf(d), TYPE_DOUBLE)).doubleValue();
    }
    ...
    public static String getString(JSONObject jSONObject, String str, String str2) {
        return (String) getValueByType(jSONObject, str, str2, TYPE_STRING);
    }
    ...
    public static String getString(String str, String str2, String str3) {
        return (String) getValueByType(str, str2, str3, TYPE_STRING);
    }
