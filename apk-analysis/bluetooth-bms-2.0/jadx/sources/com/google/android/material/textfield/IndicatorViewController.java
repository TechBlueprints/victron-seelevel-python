...
final class IndicatorViewController {
    ...
    void hideHelperText() throws NoSuchMethodException, SecurityException, ClassNotFoundException {
        cancelCaptionAnimator();
        if (this.captionDisplayed == 2) {
    ...
    private void updateCaptionViewsVisibility(final int i, final int i2, boolean z) throws NoSuchMethodException, SecurityException, ClassNotFoundException {
        if (i == i2) {
            return;
        }
        if (z) {
