...
public class BottomNavigationMenuView extends ViewGroup implements MenuView {
    ...
    protected void onMeasure(int i, int i2) {
        ...
        int iMakeMeasureSpec = View.MeasureSpec.makeMeasureSpec(this.itemHeight, MemoryConstants.GB);
        ...
        for (int i9 = 0; i9 < childCount; i9++) {
            ...
            if (childAt2.getVisibility() != 8) {
                childAt2.measure(View.MeasureSpec.makeMeasureSpec(this.tempChildWidths[i9], MemoryConstants.GB), iMakeMeasureSpec);
                childAt2.getLayoutParams().width = childAt2.getMeasuredWidth();
                measuredWidth += childAt2.getMeasuredWidth();
            }
        }
        setMeasuredDimension(View.resolveSizeAndState(measuredWidth, View.MeasureSpec.makeMeasureSpec(measuredWidth, MemoryConstants.GB), 0), View.resolveSizeAndState(this.itemHeight, iMakeMeasureSpec, 0));
    }
