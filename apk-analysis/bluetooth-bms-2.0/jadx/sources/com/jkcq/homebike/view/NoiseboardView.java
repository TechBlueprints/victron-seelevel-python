...
public class NoiseboardView extends View {
    ...
    public NoiseboardView(Context context, AttributeSet attributeSet, int i) throws Resources.NotFoundException {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        this.mPaintScaleText.setColor(getResources().getColor(com.ble.vanomize12.R.color.common_page_color));
        ...
        Double dValueOf = Double.valueOf((this.mSweepAngle * 1.0d) / 200.0d);
        float fDoubleValue = (float) (this.mStartAngle + (dValueOf.doubleValue() * this.curSpeed));
        float[] coordinatePoint6 = getCoordinatePoint(this.mRadius, (float) (this.mStartAngle + (dValueOf.doubleValue() * this.curSpeed2)));
        float[] coordinatePoint7 = getCoordinatePoint(this.mTargetScaleRadius, fDoubleValue);
        float[] coordinatePoint8 = getCoordinatePoint(this.mRadius, (float) (this.mStartAngle + (dValueOf.doubleValue() * this.curSpeed3)));
        this.path.reset();
        ...
        this.mPaintCirclePointer.setColor(getResources().getColor(com.ble.vanomize12.R.color.common_page_color));
        this.mPaintCirclePointer.setStyle(Paint.Style.FILL);
        this.mPaintCirclePointer.setStrokeWidth((float) dpToPx(4));
        canvas.drawCircle(this.mCenterX, this.mCenterY, dpToPx(4), this.mPaintCirclePointer);
        canvas.drawCircle((coordinatePoint9[0] + coordinatePoint10[0]) / 2.0f, (coordinatePoint9[1] + coordinatePoint10[1]) / 2.0f, this.mCircleRadius / 2, this.mPaintCirclePointer);
