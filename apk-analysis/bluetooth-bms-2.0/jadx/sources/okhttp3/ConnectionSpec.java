...
public final class ConnectionSpec {
    ...
    public final List<CipherSuite> m1067deprecated_cipherSuites() {
        return cipherSuites();
    }
    ...
    public final List<TlsVersion> m1069deprecated_tlsVersions() {
        return tlsVersions();
    }
    ...
    public int hashCode() {
        ...
        int iHashCode = (527 + Arrays.hashCode(strArr)) * 31;
        String[] strArr2 = this.tlsVersionsAsString;
        if (strArr2 == null) {
            Intrinsics.throwNpe();
        }
        return ((iHashCode + Arrays.hashCode(strArr2)) * 31) + (!this.supportsTlsExtensions ? 1 : 0);
    }
