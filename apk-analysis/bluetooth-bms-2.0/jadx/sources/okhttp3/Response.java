...
public final class Response implements Closeable {
    ...
    public final ResponseBody peekBody(long byteCount) throws IOException {
        ...
        buffer.write(bufferedSourcePeek, Math.min(byteCount, bufferedSourcePeek.getBuffer().size()));
    ...
    public final CacheControl m1158deprecated_cacheControl() {
        return cacheControl();
    }
