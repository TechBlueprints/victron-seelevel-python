...
public final class Http1ExchangeCodec implements ExchangeCodec {
    ...
    public void writeRequestHeaders(Request request) {
        ...
        Proxy.Type type = realConnection.getRoute().proxy().type();
    ...
    public Response.Builder readResponseHeaders(boolean expectContinue) {
        ...
        try {
            StatusLine statusLine = StatusLine.INSTANCE.parse(readHeaderLine());
            ...
            RealConnection realConnection = this.realConnection;
            if (realConnection == null || (route = realConnection.getRoute()) == null || (address = route.address()) == null || (httpUrlUrl = address.url()) == null || (strRedact = httpUrlUrl.redact()) == null) {
                strRedact = EnvironmentCompat.MEDIA_UNKNOWN;
            }
