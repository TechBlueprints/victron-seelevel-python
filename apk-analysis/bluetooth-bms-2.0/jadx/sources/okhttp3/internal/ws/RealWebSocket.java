...
public final class RealWebSocket implements WebSocket, WebSocketReader.FrameCallback {
    ...
    public final void connect(OkHttpClient client) {
        ...
        RealCall realCallNewRealCall = RealCall.INSTANCE.newRealCall(okHttpClientBuild, requestBuild, true);
        ...
        synchronized (this) {
            ...
            try {
                if (byteStringPoll != null) {
                    ...
                    BufferedSink bufferedSinkBuffer = Okio.buffer(webSocketWriter.newMessageSink(message.getFormatOpcode(), data.size()));
    ...
    /* compiled from: RealWebSocket.kt */
    @Metadata(bv = {1, 0, 3}, d1 = {"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\b\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0006\b\u0000\u0018\u00002\u00020\u0001B\u0015\u0012\u0006\u0010\u0002\u001a\u00020\u0003\u0012\u0006\u0010\u0004\u001a\u00020\u0005¢\u0006\u0002\u0010\u0006R\u0011\u0010\u0004\u001a\u00020\u0005¢\u0006\b\n\u0000\u001a\u0004\b\u0007\u0010\bR\u0011\u0010\u0002\u001a\u00020\u0003¢\u0006\b\n\u0000\u001a\u0004\b\t\u0010\n¨\u0006\u000b"}, d2 = {"Lokhttp3/internal/ws/RealWebSocket$Message;", "", "formatOpcode", "", LogContract.LogColumns.DATA, "Lokio/ByteString;", "(ILokio/ByteString;)V", "getData", "()Lokio/ByteString;", "getFormatOpcode", "()I", "okhttp"}, k = 1, mv = {1, 1, 15})
