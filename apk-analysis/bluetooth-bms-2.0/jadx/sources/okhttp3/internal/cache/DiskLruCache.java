...
public final class DiskLruCache implements Closeable, Flushable {
    ...
    public final synchronized void initialize() throws IOException {
        ...
        if (this.fileSystem.exists(this.journalFile)) {
            try {
                ...
                Platform.INSTANCE.get().log(5, "DiskLruCache " + this.directory + " is corrupt: " + e.getMessage() + ", removing", e);
                try {
                    delete();
                    this.closed = false;
                } catch (Throwable th) {
    ...
    private final void readJournalLine(String line) throws IOException {
        ...
        if (iIndexOf$default2 == -1 && iIndexOf$default == READ.length() && StringsKt.startsWith$default(line, READ, false, 2, (Object) null)) {
            return;
        }
        throw new IOException("unexpected journal line: " + line);
    }
