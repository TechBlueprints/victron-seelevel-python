...
public final class Jdk8WithJettyBootPlatform extends Platform {
    ...
    @Override // okhttp3.internal.platform.Platform
    public String getSelectedProtocol(SSLSocket socket) throws IllegalArgumentException {
        ...
        try {
            ...
            if (!alpnProvider.getUnsupported() && alpnProvider.getSelected() == null) {
                Platform.INSTANCE.get().log(4, "ALPN callback dropped: HTTP/2 is disabled. Is alpn-boot on the boot class path?", null);
                return null;
            }
