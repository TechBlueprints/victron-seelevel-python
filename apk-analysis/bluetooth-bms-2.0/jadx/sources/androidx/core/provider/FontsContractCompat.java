...
public class FontsContractCompat {
    ...
    static FontInfo[] getFontFromProvider(Context context, FontRequest fontRequest, String str, CancellationSignal cancellationSignal) {
        ...
        ArrayList arrayList = new ArrayList();
        Uri uriBuild = new Uri.Builder().scheme(LogContract.Session.Content.CONTENT).authority(str).build();
        Uri uriBuild2 = new Uri.Builder().scheme(LogContract.Session.Content.CONTENT).authority(str).appendPath("file").build();
