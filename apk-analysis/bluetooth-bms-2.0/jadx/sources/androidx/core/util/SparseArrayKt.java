...
public final class SparseArrayKt {
    ...
    public static final class C00181<T> implements Iterator<T>, KMappedMarker {
        ...
        C00181(SparseArray<T> sparseArray) {
    ...
    public static final <T> Iterator<T> valueIterator(SparseArray<T> valueIterator) {
        ...
        return new C00181(valueIterator);
    }
