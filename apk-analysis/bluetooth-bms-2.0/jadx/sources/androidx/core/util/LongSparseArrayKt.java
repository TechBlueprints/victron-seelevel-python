...
public final class LongSparseArrayKt {
    ...
    public static final class C00171<T> implements Iterator<T>, KMappedMarker {
        ...
        C00171(LongSparseArray<T> longSparseArray) {
    ...
    public static final <T> Iterator<T> valueIterator(LongSparseArray<T> valueIterator) {
        ...
        return new C00171(valueIterator);
    }
