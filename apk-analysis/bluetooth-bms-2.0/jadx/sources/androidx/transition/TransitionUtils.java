...
class TransitionUtils {
    ...
    static View copyViewImage(ViewGroup viewGroup, View view, View view2) {
        ...
        imageView.measure(View.MeasureSpec.makeMeasureSpec(iRound3 - iRound, MemoryConstants.GB), View.MeasureSpec.makeMeasureSpec(iRound4 - iRound2, MemoryConstants.GB));
