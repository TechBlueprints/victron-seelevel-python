...
public final class FlowLiveDataConversions$asLiveData$1$invokeSuspend$$inlined$collect$1<T> implements FlowCollector<T> {
    ...
    @DebugMetadata(c = "androidx.lifecycle.FlowLiveDataConversions$asLiveData$1$invokeSuspend$$inlined$collect$1", f = "FlowLiveData.kt", i = {0, 0, 0, 0}, l = {GattError.GATT_PENDING}, m = "emit", n = {"this", "value", "continuation", ConstantLanguages.ITALIAN}, s = {"L$0", "L$1", "L$2", "L$3"})
