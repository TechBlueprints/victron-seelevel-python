...
public final class TransformationsKt {
    ...
    public static final <X, Y> LiveData<Y> switchMap(LiveData<X> switchMap, final Function1<? super X, ? extends LiveData<Y>> transform) {
        ...
        LiveData<Y> liveDataSwitchMap = Transformations.switchMap(switchMap, new Function<X, LiveData<Y>>() { // from class: androidx.lifecycle.TransformationsKt.switchMap.1
            ...
            public /* bridge */ /* synthetic */ Object apply(Object obj) {
                return apply((C00281<I, O, X, Y>) obj);
            }
        ...
        Intrinsics.checkExpressionValueIsNotNull(liveDataSwitchMap, "Transformations.switchMap(this) { transform(it) }");
    ...
    public static final <X> LiveData<X> distinctUntilChanged(LiveData<X> distinctUntilChanged) {
        ...
        Intrinsics.checkExpressionValueIsNotNull(liveDataDistinctUntilChanged, "Transformations.distinctUntilChanged(this)");
