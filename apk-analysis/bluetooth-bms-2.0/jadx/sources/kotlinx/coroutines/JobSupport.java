...
public class JobSupport implements Job, ChildJob, ParentJob, SelectClause0 {
    ...
    private final boolean tryFinalizeFinishingState(Finishing state, Object proposedUpdate, int mode) throws Throwable {
        ...
        if (!_state$FU.compareAndSet(this, state, JobSupportKt.boxIncomplete(proposedUpdate))) {
    ...
    private final void addSuppressedExceptions(Throwable rootCause, List<? extends Throwable> exceptions) {
        ...
        Set setIdentitySet = ConcurrentKt.identitySet(exceptions.size());
        Throwable thUnwrap = StackTraceRecoveryKt.unwrap(rootCause);
        Iterator<? extends Throwable> it = exceptions.iterator();
        while (it.hasNext()) {
            Throwable thUnwrap2 = StackTraceRecoveryKt.unwrap(it.next());
            if (thUnwrap2 != rootCause && thUnwrap2 != thUnwrap && !(thUnwrap2 instanceof CancellationException) && setIdentitySet.add(thUnwrap2)) {
                kotlin.ExceptionsKt.addSuppressed(rootCause, thUnwrap2);
            }
        }
    }
    ...
    */
    private final void notifyCancelling(kotlinx.coroutines.NodeList r8, java.lang.Throwable r9) throws java.lang.Throwable {
        ...
        Le:
            ...
            r2.invoke(r9)     // Catch: java.lang.Throwable -> L24
            goto L53
        L24:
            r3 = move-exception
            if (r0 == 0) goto L2d
    ...
    private final boolean cancelParent(Throwable cause) {
        ...
        ChildHandle childHandle = this.parentHandle;
        return (childHandle == null || childHandle == NonDisposableHandle.INSTANCE) ? z : childHandle.childCancelled(cause) || z;
    }
    ...
    */
    private final /* synthetic */ <T extends kotlinx.coroutines.JobNode<?>> void notifyHandlers(kotlinx.coroutines.NodeList r8, java.lang.Throwable r9) throws java.lang.Throwable {
        ...
        Lb:
            ...
            r2 = r1
            kotlinx.coroutines.JobNode r2 = (kotlinx.coroutines.JobNode) r2
            r2.invoke(r9)     // Catch: java.lang.Throwable -> L27
            goto L56
        L27:
            r3 = move-exception
            if (r0 == 0) goto L30
    ...
    */
    private final void notifyCompletion(kotlinx.coroutines.NodeList r8, java.lang.Throwable r9) throws java.lang.Throwable {
        ...
        Lb:
            ...
            r2 = r1
            kotlinx.coroutines.JobNode r2 = (kotlinx.coroutines.JobNode) r2
            r2.invoke(r9)     // Catch: java.lang.Throwable -> L21
            goto L50
        L21:
            r3 = move-exception
            if (r0 == 0) goto L2a
    ...
    private final boolean addLastAtomic(final Object expect, NodeList list, JobNode<?> node) {
        ...
        do {
            ...
            iTryCondAddNext = ((LockFreeLinkedListNode) prev).tryCondAddNext(jobNode, list, condAddOp);
    ...
    private final boolean cancelMakeCompleting(Object cause) {
        ...
        do {
            Object state$kotlinx_coroutines_core = getState$kotlinx_coroutines_core();
            if (!(state$kotlinx_coroutines_core instanceof Incomplete) || (((state$kotlinx_coroutines_core instanceof Finishing) && ((Finishing) state$kotlinx_coroutines_core).completing) || (iTryMakeCompleting = tryMakeCompleting(state$kotlinx_coroutines_core, new CompletedExceptionally(createCauseException(cause), false, 2, null), 0)) == 0)) {
                return false;
            }
