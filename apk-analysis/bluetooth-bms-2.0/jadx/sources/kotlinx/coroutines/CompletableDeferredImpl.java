...
final class CompletableDeferredImpl<T> extends JobSupport implements CompletableDeferred<T>, SelectClause1<T> {
    ...
    /* renamed from: kotlinx.coroutines.CompletableDeferredImpl$await$1, reason: invalid class name */
    ...
    */
    public java.lang.Object await(kotlin.coroutines.Continuation<? super T> r5) {
        /*
            r4 = this;
            boolean r0 = r5 instanceof kotlinx.coroutines.CompletableDeferredImpl.AnonymousClass1
            if (r0 == 0) goto L14
            r0 = r5
            kotlinx.coroutines.CompletableDeferredImpl$await$1 r0 = (kotlinx.coroutines.CompletableDeferredImpl.AnonymousClass1) r0
            int r1 = r0.label
