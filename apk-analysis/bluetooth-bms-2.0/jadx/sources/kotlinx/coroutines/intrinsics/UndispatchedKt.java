...
public final class UndispatchedKt {
    ...
    public static final <T, R> Object startUndispatchedOrReturnIgnoreTimeout(AbstractCoroutine<? super T> startUndispatchedOrReturnIgnoreTimeout, R r, Function2<? super R, ? super Continuation<? super T>, ? extends Object> block) throws Throwable {
        Object completedExceptionally;
    ...
    private static final <T> Object undispatchedResult(AbstractCoroutine<? super T> abstractCoroutine, Function1<? super Throwable, Boolean> function1, Function0<? extends Object> function0) throws Throwable {
        Object completedExceptionally;
        try {
    ...
    public static final <T> void startCoroutineUnintercepted(Function1<? super Continuation<? super T>, ? extends Object> startCoroutineUnintercepted, Continuation<? super T> completion) {
        ...
        try {
            Object objInvoke = ((Function1) TypeIntrinsics.beforeCheckcastToFunctionOfArity(startCoroutineUnintercepted, 1)).invoke(continuationProbeCoroutineCreated);
            if (objInvoke != IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                Result.Companion companion = Result.INSTANCE;
                continuationProbeCoroutineCreated.resumeWith(Result.m13constructorimpl(objInvoke));
            }
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            continuationProbeCoroutineCreated.resumeWith(Result.m13constructorimpl(ResultKt.createFailure(th)));
        }
    }
    ...
    public static final <R, T> void startCoroutineUnintercepted(Function2<? super R, ? super Continuation<? super T>, ? extends Object> startCoroutineUnintercepted, R r, Continuation<? super T> completion) {
        ...
        Continuation continuationProbeCoroutineCreated = DebugProbesKt.probeCoroutineCreated(completion);
        try {
            Object objInvoke = ((Function2) TypeIntrinsics.beforeCheckcastToFunctionOfArity(startCoroutineUnintercepted, 2)).invoke(r, continuationProbeCoroutineCreated);
            if (objInvoke != IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                Result.Companion companion = Result.INSTANCE;
                continuationProbeCoroutineCreated.resumeWith(Result.m13constructorimpl(objInvoke));
            }
    ...
    public static final <T> void startCoroutineUndispatched(Function1<? super Continuation<? super T>, ? extends Object> startCoroutineUndispatched, Continuation<? super T> completion) {
        ...
        try {
            ...
            try {
                Object objInvoke = ((Function1) TypeIntrinsics.beforeCheckcastToFunctionOfArity(startCoroutineUndispatched, 1)).invoke(continuationProbeCoroutineCreated);
                if (objInvoke != IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                    Result.Companion companion = Result.INSTANCE;
                    continuationProbeCoroutineCreated.resumeWith(Result.m13constructorimpl(objInvoke));
                }
