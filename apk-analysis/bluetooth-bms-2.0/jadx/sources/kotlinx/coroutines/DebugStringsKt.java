...
public final class DebugStringsKt {
    ...
    public static final String toDebugString(Continuation<?> toDebugString) {
        ...
        try {
            ...
            objM13constructorimpl = Result.m13constructorimpl(toDebugString + '@' + getHexAddress(toDebugString));
        } catch (Throwable th) {
        ...
        if (Result.m16exceptionOrNullimpl(objM13constructorimpl) != null) {
            objM13constructorimpl = toDebugString.getClass().getName() + '@' + getHexAddress(toDebugString);
        }
        return (String) objM13constructorimpl;
    }
