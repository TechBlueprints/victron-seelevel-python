        ...
        while (true) {
            ...
            synchronized (threadSafeHeap) {
                ...
                if (threadSafeHeapNodeFirstImpl != null) {
                    objRemoveAtImpl = (((TimedRunnable) threadSafeHeapNodeFirstImpl).time > targetTime ? 1 : (((TimedRunnable) threadSafeHeapNodeFirstImpl).time == targetTime ? 0 : -1)) <= 0 ? threadSafeHeap.removeAtImpl(0) : null;
                }
            }
            TimedRunnable timedRunnable = (TimedRunnable) objRemoveAtImpl;
            if (timedRunnable == null) {
                return;
            }
