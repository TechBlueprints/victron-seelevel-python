...
public final class StackTraceRecoveryKt {
    ...
    static {
        ...
        try {
            ...
            objM13constructorimpl = Result.m13constructorimpl(cls.getCanonicalName());
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM13constructorimpl = Result.m13constructorimpl(ResultKt.createFailure(th));
        }
        if (Result.m16exceptionOrNullimpl(objM13constructorimpl) == null) {
            obj2 = objM13constructorimpl;
        }
        ...
        try {
            ...
            objM13constructorimpl2 = Result.m13constructorimpl(cls2.getCanonicalName());
        } catch (Throwable th2) {
            Result.Companion companion4 = Result.INSTANCE;
            objM13constructorimpl2 = Result.m13constructorimpl(ResultKt.createFailure(th2));
        }
        if (Result.m16exceptionOrNullimpl(objM13constructorimpl2) == null) {
            obj = objM13constructorimpl2;
        }
    ...
    public static final <E extends Throwable> E recoverStackTrace(E exception) {
        ...
        return (DebugKt.getRECOVER_STACK_TRACES() && (thTryCopyException = ExceptionsConstuctorKt.tryCopyException(exception)) != null) ? (E) sanitizeStackTrace(thTryCopyException) : exception;
    }
    ...
    private static final <E extends Throwable> E sanitizeStackTrace(E e) {
        ...
        int iFrameIndex = frameIndex(stackTrace, stackTraceRecoveryClassName2);
        int i = iFrameIndex + 1;
        ...
        int iFrameIndex2 = frameIndex(stackTrace, baseContinuationImplClassName2);
