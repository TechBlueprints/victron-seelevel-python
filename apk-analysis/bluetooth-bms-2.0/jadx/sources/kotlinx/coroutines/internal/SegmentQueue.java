...
public abstract class SegmentQueue<S extends Segment<S>> {
    ...
    public SegmentQueue() {
        Segment segmentNewSegment$default = newSegment$default(this, 0L, null, 2, null);
        this._head = segmentNewSegment$default;
        this._tail = segmentNewSegment$default;
    }
