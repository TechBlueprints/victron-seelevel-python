    ...
    public final E removeFirstOrNullIf(Function1<? super E, Boolean> predicate) {
        ...
        while (true) {
            ...
            while (true) {
                ...
                obj = (Object) lockFreeTaskQueueCore.array$internal.get(lockFreeTaskQueueCore.mask & i);
                if (obj == null) {
                    if (lockFreeTaskQueueCore.singleConsumer) {
                        break;
                    }
                } else {
                    if ((obj instanceof LockFreeTaskQueueCore.Placeholder) || !predicate.invoke(obj).booleanValue()) {
                        break;
                    }
                    int i2 = (i + 1) & LockFreeTaskQueueCore.MAX_CAPACITY_MASK;
                    if (LockFreeTaskQueueCore._state$FU$internal.compareAndSet(lockFreeTaskQueueCore, j, LockFreeTaskQueueCore.INSTANCE.updateHead(j, i2))) {
