...
public final class ExceptionsConstuctorKt {
    ...
    public static final <E extends Throwable> E tryCopyException(E exception) {
        ...
        if (exception instanceof CopyableThrowable) {
            try {
                ...
                objM13constructorimpl = Result.m13constructorimpl(((CopyableThrowable) exception).createCopy());
            } catch (Throwable th) {
                Result.Companion companion2 = Result.INSTANCE;
                objM13constructorimpl = Result.m13constructorimpl(ResultKt.createFailure(th));
            }
            return (E) (Result.m19isFailureimpl(objM13constructorimpl) ? null : objM13constructorimpl);
        }
            ...
            return new Function1<Throwable, Throwable>() { // from class: kotlinx.coroutines.internal.ExceptionsConstuctorKt$createConstructor$$inlined$safeCtor$4
                ...
                public final Throwable invoke(Throwable e) {
                    ...
                    if (objNewInstance != null) {
                        ...
                        th2.initCause(e);
                        objM13constructorimpl = Result.m13constructorimpl(th2);
                        if (Result.m19isFailureimpl(objM13constructorimpl)) {
                            objM13constructorimpl = null;
                        }
                        return (Throwable) objM13constructorimpl;
                    }
            ...
            if (length == 2 && Intrinsics.areEqual(parameterTypes[0], String.class) && Intrinsics.areEqual(parameterTypes[1], Throwable.class)) {
                return new Function1<Throwable, Throwable>() { // from class: kotlinx.coroutines.internal.ExceptionsConstuctorKt$createConstructor$$inlined$safeCtor$1
                    ...
                    public final Throwable invoke(Throwable e) {
                        ...
                        if (objNewInstance != null) {
                            objM13constructorimpl = Result.m13constructorimpl((Throwable) objNewInstance);
                            if (Result.m19isFailureimpl(objM13constructorimpl)) {
                                objM13constructorimpl = null;
                            }
                            return (Throwable) objM13constructorimpl;
    ...
    private static final Function1<Throwable, Throwable> safeCtor(final Function1<? super Throwable, ? extends Throwable> function1) {
        return new Function1<Throwable, Throwable>() { // from class: kotlinx.coroutines.internal.ExceptionsConstuctorKt.safeCtor.1
            ...
            public final Throwable invoke(Throwable e) {
                ...
                try {
                    Result.Companion companion = Result.INSTANCE;
                    objM13constructorimpl = Result.m13constructorimpl((Throwable) function1.invoke(e));
                } catch (Throwable th) {
                    Result.Companion companion2 = Result.INSTANCE;
                    objM13constructorimpl = Result.m13constructorimpl(ResultKt.createFailure(th));
                }
    ...
    private static final int fieldsCountOrDefault(Class<?> cls, int i) {
        ...
        try {
            Result.Companion companion = Result.INSTANCE;
            objM13constructorimpl = Result.m13constructorimpl(Integer.valueOf(fieldsCount$default(cls, 0, 1, null)));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM13constructorimpl = Result.m13constructorimpl(ResultKt.createFailure(th));
        }
        ...
        if (Result.m19isFailureimpl(objM13constructorimpl)) {
            objM13constructorimpl = numValueOf;
        }
        return ((Number) objM13constructorimpl).intValue();
    }
