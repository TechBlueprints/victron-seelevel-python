...
public class LockFreeLinkedListNode {
    ...
    public static final class AnonymousClass1 extends CondAddOp {
        ...
        public AnonymousClass1(Function0 function0, LockFreeLinkedListNode lockFreeLinkedListNode, LockFreeLinkedListNode lockFreeLinkedListNode2) {
    ...
    public final CondAddOp makeCondAddOp(LockFreeLinkedListNode node, Function0<Boolean> condition) {
        ...
        return new AnonymousClass1(condition, node, node);
    }
            ...
            while (true) {
                ...
                if (obj instanceof OpDescriptor) {
                    ...
                    if (retry(lockFreeLinkedListNodeTakeAffectedNode, obj)) {
                        ...
                        if (LockFreeLinkedListNode._next$FU.compareAndSet(lockFreeLinkedListNodeTakeAffectedNode, obj, prepareOp) && (objPerform = prepareOp.perform(lockFreeLinkedListNodeTakeAffectedNode)) != LockFreeLinkedListKt.REMOVE_PREPARED) {
                            return objPerform;
                        }
                    } else {
                        throw new TypeCastException("null cannot be cast to non-null type kotlinx.coroutines.internal.Node /* = kotlinx.coroutines.internal.LockFreeLinkedListNode */");
    ...
    private final LockFreeLinkedListNode findHead() {
        ...
        LockFreeLinkedListNode nextNode = lockFreeLinkedListNode;
    ...
    public final void helpDelete() {
        ...
        while (true) {
            ...
            _next$FU.compareAndSet(lockFreeLinkedListNode3, lockFreeLinkedListNodeMarkPrev, ((Removed) next).ref);
    ...
    public final boolean addLastIf(LockFreeLinkedListNode node, Function0<Boolean> condition) {
        ...
        Intrinsics.checkParameterIsNotNull(node, "node");
        Intrinsics.checkParameterIsNotNull(condition, "condition");
        AnonymousClass1 anonymousClass1 = new AnonymousClass1(condition, node, node);
        do {
            Object prev = getPrev();
            if (prev == null) {
                throw new TypeCastException("null cannot be cast to non-null type kotlinx.coroutines.internal.Node /* = kotlinx.coroutines.internal.LockFreeLinkedListNode */");
            }
            iTryCondAddNext = ((LockFreeLinkedListNode) prev).tryCondAddNext(node, this, anonymousClass1);
    ...
    public final boolean addLastIfPrevAndIf(LockFreeLinkedListNode node, Function1<? super LockFreeLinkedListNode, Boolean> predicate, Function0<Boolean> condition) {
        ...
        do {
            ...
            iTryCondAddNext = lockFreeLinkedListNode.tryCondAddNext(node, this, anonymousClass1);
            if (iTryCondAddNext == 1) {
                return true;
            }
        } while (iTryCondAddNext != 2);
