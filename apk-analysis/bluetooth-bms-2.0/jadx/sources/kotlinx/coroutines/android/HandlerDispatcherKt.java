...
public final class HandlerDispatcherKt {
    ...
    public static final Handler asHandler(Looper asHandler, boolean z) throws IllegalAccessException, NoSuchMethodException, InstantiationException, SecurityException, IllegalArgumentException, InvocationTargetException {
        ...
        try {
            ...
            Object objNewInstance = declaredConstructor.newInstance(asHandler, null, true);
    ...
    static {
        ...
        try {
            ...
            objM13constructorimpl = Result.m13constructorimpl(new HandlerContext(asHandler(mainLooper, true), "Main"));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM13constructorimpl = Result.m13constructorimpl(ResultKt.createFailure(th));
        }
        if (Result.m19isFailureimpl(objM13constructorimpl)) {
            objM13constructorimpl = null;
        }
        Main = (HandlerDispatcher) objM13constructorimpl;
    }
    ...
    public static final Object awaitFrame(Continuation<? super Long> continuation) {
        ...
        Dispatchers.getMain().mo1037dispatch(EmptyCoroutineContext.INSTANCE, new Runnable() { // from class: kotlinx.coroutines.android.HandlerDispatcherKt$$special$$inlined$Runnable$1
