...
public final class ResumeModeKt {
    ...
    public static final <T> void resumeMode(Continuation<? super T> resumeMode, T t, int i) {
        ...
        if (i == 0) {
            ...
            resumeMode.resumeWith(Result.m13constructorimpl(t));
            return;
        }
        if (i == 1) {
    ...
    public static final <T> void resumeWithExceptionMode(Continuation<? super T> resumeWithExceptionMode, Throwable exception, int i) {
        ...
        if (i == 0) {
            Result.Companion companion = Result.INSTANCE;
            resumeWithExceptionMode.resumeWith(Result.m13constructorimpl(ResultKt.createFailure(exception)));
            return;
        }
        if (i == 1) {
    ...
    public static final <T> void resumeUninterceptedMode(Continuation<? super T> resumeUninterceptedMode, T t, int i) {
        ...
        if (i == 0) {
            Continuation continuationIntercepted = IntrinsicsKt.intercepted(resumeUninterceptedMode);
            Result.Companion companion = Result.INSTANCE;
            continuationIntercepted.resumeWith(Result.m13constructorimpl(t));
            return;
        }
        if (i == 1) {
        ...
        if (i == 2) {
            Result.Companion companion2 = Result.INSTANCE;
            resumeUninterceptedMode.resumeWith(Result.m13constructorimpl(t));
            return;
        }
        if (i != 3) {
            if (i == 4) {
    ...
    public static final <T> void resumeUninterceptedWithExceptionMode(Continuation<? super T> resumeUninterceptedWithExceptionMode, Throwable exception, int i) {
        ...
        Intrinsics.checkParameterIsNotNull(exception, "exception");
        if (i == 0) {
            Continuation continuationIntercepted = IntrinsicsKt.intercepted(resumeUninterceptedWithExceptionMode);
            Result.Companion companion = Result.INSTANCE;
            continuationIntercepted.resumeWith(Result.m13constructorimpl(ResultKt.createFailure(exception)));
            return;
        }
        if (i == 1) {
        ...
        if (i == 2) {
            Result.Companion companion2 = Result.INSTANCE;
            resumeUninterceptedWithExceptionMode.resumeWith(Result.m13constructorimpl(ResultKt.createFailure(exception)));
            return;
        }
        if (i != 3) {
            if (i == 4) {
