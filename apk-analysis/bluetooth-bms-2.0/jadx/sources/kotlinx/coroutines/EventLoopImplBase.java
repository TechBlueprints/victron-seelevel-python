...
public abstract class EventLoopImplBase extends EventLoopImplPlatform implements Delay {
    ...
    public void mo1038scheduleResumeAfterDelay(long timeMillis, CancellableContinuation<? super Unit> continuation) {
        ...
        if (jDelayToNanos < 4611686018427387903L) {
            ...
            DelayedResumeTask delayedResumeTask = new DelayedResumeTask(this, jDelayToNanos + jNanoTime, continuation);
    ...
    public final void mo1037dispatch(CoroutineContext context, Runnable block) {
