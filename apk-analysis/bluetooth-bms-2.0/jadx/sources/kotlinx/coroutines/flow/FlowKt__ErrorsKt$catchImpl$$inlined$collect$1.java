...
public final class FlowKt__ErrorsKt$catchImpl$$inlined$collect$1<T> implements FlowCollector<T> {
    ...
    @DebugMetadata(c = "kotlinx.coroutines.flow.FlowKt__ErrorsKt$catchImpl$$inlined$collect$1", f = "Errors.kt", i = {0, 0, 0, 0}, l = {GattError.GATT_AUTH_FAIL}, m = "emit", n = {"this", "value", "continuation", ConstantLanguages.ITALIAN}, s = {"L$0", "L$1", "L$2", "L$3"})
