    ...
    public static final <T, R> Flow<R> flowWith(final Flow<? extends T> flowWith, final CoroutineContext flowContext, final int i, final Function1<? super Flow<? extends T>, ? extends Flow<? extends R>> builder) {
        ...
        return new Flow<R>() { // from class: kotlinx.coroutines.flow.FlowKt__ContextKt$flowWith$$inlined$unsafeFlow$1
            ...
            public Object collect(final FlowCollector flowCollector, Continuation continuation) {
                return FlowKt.buffer(FlowKt.flowOn((Flow) builder.invoke(FlowKt.buffer(FlowKt.flowOn(flowWith, continuation.getContext().minusKey(Job.INSTANCE)), i)), flowContext), i).collect(new FlowCollector<R>() { // from class: kotlinx.coroutines.flow.FlowKt__ContextKt$flowWith$$inlined$unsafeFlow$1$lambda$1
                    @Override // kotlinx.coroutines.flow.FlowCollector
                    public Object emit(Object obj, Continuation continuation2) {
                        return flowCollector.emit(obj, continuation2);
                    }
                }, continuation);
            }
        };
