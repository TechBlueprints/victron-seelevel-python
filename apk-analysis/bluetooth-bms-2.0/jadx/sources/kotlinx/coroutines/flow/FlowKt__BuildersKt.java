...
final /* synthetic */ class FlowKt__BuildersKt {
    ...
    /* renamed from: kotlinx.coroutines.flow.FlowKt__BuildersKt$flowViaChannel$1, reason: invalid class name */
    ...
    public static final <T> Flow<T> flowViaChannel(int i, Function2<? super CoroutineScope, ? super SendChannel<? super T>, Unit> block) {
        Intrinsics.checkParameterIsNotNull(block, "block");
        return FlowKt.buffer(FlowKt.channelFlow(new AnonymousClass1(block, null)), i);
    }
    ...
    public static final <T> Flow<T> asFlow(final Function0<? extends T> asFlow) {
        ...
        return new Flow<T>() { // from class: kotlinx.coroutines.flow.FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$1
            ...
            public Object collect(FlowCollector flowCollector, Continuation continuation) {
                return flowCollector.emit(asFlow.invoke(), continuation);
            }
        };
    }
