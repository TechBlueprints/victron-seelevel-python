...
public final class ChannelFlowMerge<T> extends ChannelFlow<T> {
    ...
    protected Object collectTo(ProducerScope<? super T> producerScope, Continuation<? super Unit> continuation) {
        Semaphore semaphoreSemaphore$default = SemaphoreKt.Semaphore$default(this.concurrency, 0, 2, null);
        SendingCollector sendingCollector = new SendingCollector(producerScope);
        return this.flow.collect(new ChannelFlowMerge$collectTo$$inlined$collect$1((Job) continuation.getContext().get(Job.INSTANCE), semaphoreSemaphore$default, producerScope, sendingCollector), continuation);
    }
