...
public final class SafeCollector<T> implements FlowCollector<T> {
    ...
    private final void checkContext(CoroutineContext currentContext) {
        if (((Number) currentContext.fold(0, new Function2<Integer, CoroutineContext.Element, Integer>() { // from class: kotlinx.coroutines.flow.internal.SafeCollector$checkContext$result$1
            {
                super(2);
            }
            ...
            public final int invoke(int i, CoroutineContext.Element element) {
                ...
                Job jobTransitiveCoroutineParent = this.this$0.transitiveCoroutineParent((Job) element, job);
