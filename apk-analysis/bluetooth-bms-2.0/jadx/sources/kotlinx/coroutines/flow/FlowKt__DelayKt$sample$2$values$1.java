...
@DebugMetadata(c = "kotlinx.coroutines.flow.FlowKt__DelayKt$sample$2$values$1", f = "Delay.kt", i = {0, 0}, l = {GattError.GATT_AUTH_FAIL}, m = "invokeSuspend", n = {"$this$produce", "$this$collect$iv"}, s = {"L$0", "L$1"})
...
final class FlowKt__DelayKt$sample$2$values$1 extends SuspendLambda implements Function2<ProducerScope<? super Object>, Continuation<? super Unit>, Object> {
    ...
    final /* synthetic */ FlowKt__DelayKt.C01852 this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    FlowKt__DelayKt$sample$2$values$1(FlowKt__DelayKt.C01852 c01852, Continuation continuation) {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            FlowKt__DelayKt$sample$2$values$1$invokeSuspend$$inlined$collect$1 flowKt__DelayKt$sample$2$values$1$invokeSuspend$$inlined$collect$1 = new FlowKt__DelayKt$sample$2$values$1$invokeSuspend$$inlined$collect$1(producerScope);
