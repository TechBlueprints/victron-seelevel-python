...
public final class FlowKt__CountKt$count$$inlined$collect$2<T> implements FlowCollector<T> {
    ...
    @DebugMetadata(c = "kotlinx.coroutines.flow.FlowKt__CountKt$count$$inlined$collect$2", f = "Count.kt", i = {0, 0, 0, 0, 1, 1, 1, 1}, l = {GattError.GATT_PENDING, GattError.GATT_PENDING}, m = "emit", n = {"this", "value", "continuation", "value", "this", "value", "continuation", "value"}, s = {"L$0", "L$1", "L$2", "L$3", "L$0", "L$1", "L$2", "L$3"})
