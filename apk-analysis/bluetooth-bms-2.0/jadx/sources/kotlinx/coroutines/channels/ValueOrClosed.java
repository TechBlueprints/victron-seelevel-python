...
public final class ValueOrClosed<T> {
    ...
    public static final /* synthetic */ ValueOrClosed m1024boximpl(Object obj) {
    ...
    public static Object m1025constructorimpl(Object obj) {
        return obj;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m1026equalsimpl(Object obj, Object obj2) {
        return (obj2 instanceof ValueOrClosed) && Intrinsics.areEqual(obj, ((ValueOrClosed) obj2).getHolder());
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m1027equalsimpl0(Object obj, Object obj2) {
        throw null;
    }

    /* renamed from: hashCode-impl, reason: not valid java name */
    public static int m1031hashCodeimpl(Object obj) {
        if (obj != null) {
            return obj.hashCode();
        }
        return 0;
    ...
    public boolean equals(Object other) {
        return m1026equalsimpl(this.holder, other);
    }

    public int hashCode() {
        return m1031hashCodeimpl(this.holder);
    }

    public String toString() {
        return m1033toStringimpl(this.holder);
    }
    ...
    public static final boolean m1032isClosedimpl(Object obj) {
        return obj instanceof Closed;
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* renamed from: getValue-impl, reason: not valid java name */
    public static final T m1029getValueimpl(Object obj) {
    ...
    public static final T m1030getValueOrNullimpl(Object obj) {
        if (obj instanceof Closed) {
            return null;
        }
        return obj;
    ...
    public static final Throwable m1028getCloseCauseimpl(Object obj) {
        if (obj instanceof Closed) {
    ...
    public static String m1033toStringimpl(Object obj) {
        if (obj instanceof Closed) {
            return obj.toString();
        }
        return "Value(" + obj + ')';
    ...
    public static final class Companion {
        ...
        public final <E> Object value$kotlinx_coroutines_core(E value) {
            return ValueOrClosed.m1025constructorimpl(value);
        }

        public final <E> Object closed$kotlinx_coroutines_core(Throwable cause) {
            return ValueOrClosed.m1025constructorimpl(new Closed(cause));
        }
    }
}
