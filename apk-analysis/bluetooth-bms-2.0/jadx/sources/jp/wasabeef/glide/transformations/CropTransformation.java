...
public class CropTransformation extends BitmapTransformation {
    ...
    protected Bitmap transform(Context context, BitmapPool bitmapPool, Bitmap bitmap, int i, int i2) {
        ...
        new Canvas(bitmap2).drawBitmap(bitmap, (Rect) null, new RectF(f, top, width2 + f, height2 + top), (Paint) null);
        return bitmap2;
    }
    ...
    @Override // jp.wasabeef.glide.transformations.BitmapTransformation, com.bumptech.glide.load.Key
    public int hashCode() {
        return (-1462327117) + (this.width * BuglyStrategy.a.MAX_USERDATA_VALUE_LENGTH) + (this.height * 1000) + (this.cropType.ordinal() * 10);
    }
